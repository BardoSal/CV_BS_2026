        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div>
            <p className="text-zinc-600 dark:text-zinc-400 mb-6 leading-relaxed">
              ¿Tienes un proyecto en mente o te faltan manos para sacar tus entregables? No dudes en enviarme un mensaje. Suelo responder en 24 horas.
            </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            />
            <textarea 
              name="message" placeholder="Tu mensaje" rows={4} required
              className="w-full px-4 py-3 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 focus:ring-2 focus:ring-blue-500 outline-none transition-all"
            ></textarea>
